...
export default function BlogPostClient({ blogPost, relatedPosts, slug }) {
  if (!blogPost) {
    return notFound();
  }
  ...
  return (
    <div className="pb-16">
      <div className="container mx-auto max-w-7xl  px-4 sm:px-6 lg:px-8 xl:px-0 py-12">
        ...
        {/* Call to action */}
        <div className="bg-gradient-to-r from-primary-200 to-primary-300 p-8 text-white text-center mb-12 shadow-lg">
